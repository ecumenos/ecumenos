...
import (
	...
	gen "github.com/ecumenos/ecumenos/internal/generated/orbissocius"
...
func (h *handler) GetDocs(rw http.ResponseWriter, r *http.Request) {
	...
	_, _ = rw.Write(docs.OrbisSociusDocs(h.selfURL))
}
...
func (h *handler) GetSpecs(rw http.ResponseWriter, r *http.Request) {
	filename := "orbis_socius_specs.yaml"
	...
	_, _ = rw.Write(openapi.OrbisSociusSpec(h.selfURL))
}
